...
namespace KVM_ERP.Controllers.Masters
{
    ...
    {
        KVM_ERP.Models.ApplicationDbContext context = new KVM_ERP.Models.ApplicationDbContext();
        ...
        public ActionResult Form(int? id = 0)
        {
            ...
            KVM_ERP.Models.EventMaster tab = new KVM_ERP.Models.EventMaster();
        ...
        [HttpPost]
        [Authorize(Roles = "EventMasterCreate,EventMasterEdit,AnnouncementMasterCreate,AnnouncementMasterEdit")]
        public ActionResult Form(KVM_ERP.Models.EventMaster model, HttpPostedFileBase mainImage, bool removeMainImage = false, int[] selectedCategoryIds = null)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    KVM_ERP.Models.EventMaster existing = null;
                    if (model.EventId != 0)
                    {
