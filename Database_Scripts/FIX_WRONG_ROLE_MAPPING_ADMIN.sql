-- =============================================
-- FIX WRONG ROLE MAPPING FOR ADMIN
-- =============================================
-- Problem: Admin has wrong roles mapped:
...
PRINT '========================================';
PRINT 'FIXING WRONG ROLE MAPPING FOR ADMIN';
PRINT '========================================';
...
PRINT '';
PRINT '========================================';
PRINT '✅ Done! Wrong roles removed, correct roles added for Admin.';
